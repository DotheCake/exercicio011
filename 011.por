/*
Médias
este exemplo pede ao usuário que informe 3 médias. Logo após, calcula e exibe a média final destas notas. Por último,
Verifica se alguma das médias parciais é menos que a média final e a exibe (caso exista).
*/
programa
{
  funcao inicio() 
